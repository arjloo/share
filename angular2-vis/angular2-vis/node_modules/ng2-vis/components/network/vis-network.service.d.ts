...
import { VisClusterOptions, VisEdgeOptions, VisFitOptions, VisId, VisNetworkData, VisNetworkEvents, VisNetworkOptions, VisNodeOptions, VisOpenClusterOptions, VisPosition } from './index';
/**
...
export declare class VisNetworkService {
     ...
     * @memberOf VisNetworkService
     */
    getScale(visNetwork: string): number;
    /**
     ...
     * @memberOf VisNetworkService
     */
    getViewPosition(visNetwork: string): VisPosition;
    /**
